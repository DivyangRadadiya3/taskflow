import { r as reactExports, j as jsxRuntimeExports, R as React, a as reactDomExports, b as ReactDOM, c as React2, u as useTodoStore, d as ue } from "./index-D-cnNmqe.js";
    ...
    AlertDialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display font-semibold", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { className: "text-muted-foreground text-sm", children: description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            AlertDialogAction,
            {
              ...
              onClick: onConfirm,
              className: destructive ? "bg-destructive text-destructive-foreground hover:bg-destructive/90" : "bg-accent text-accent-foreground hover:bg-accent/90",
...
function BulkActionsMenu() {
  ...
  function handleMarkAll() {
    markAllCompleted();
    ue.success(`All ${todos.length} tasks marked complete`);
  }
  function handleDeleteCompleted() {
    if (completedCount === 0) {
      ue.info("No completed tasks to clear");
      return;
    }
    setConfirmOpen(true);
  }
  ...
  function handleExport() {
    ...
    a.href = url;
    a.download = `tasks-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.json`;
    a.click();
    URL.revokeObjectURL(url);
    ue.success("Tasks exported to JSON");
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              DropdownMenuItem,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCheck, { className: "w-3.5 h-3.5 text-accent" }),
                  "Mark all complete"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              DropdownMenuItem,
              {
                ...
                className: "gap-2 cursor-pointer",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "w-3.5 h-3.5 text-muted-foreground" }),
                  "Export JSON"
                ]
              }
            ),
...
function FilterPanel() {
  ...
  const hasActiveFilter = filter !== "all" || priorityFilter !== "all" || categoryFilter !== null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 bg-muted/40 rounded-lg p-0.5 border border-border/20 w-fit", children: STATUS_FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center", children: [
      PRIORITY_FILTERS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Badge,
        {
          ...
          className: cn(
            ...
            priorityFilter === p.value && p.value === "all" ? "bg-accent/15 text-accent border-accent/30" : priorityFilter === p.value && p.value !== "all" ? p.cls : "border-border/30 text-muted-foreground hover:text-foreground"
          ),
          onClick: () => setPriorityFilter(p.value),
          children: p.value === "all" ? "All priorities" : `${p.label} priority`
        },
        p.value
      )),
      categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Badge,
        {
          ...
          className: cn(
            "cursor-pointer text-xs transition-smooth select-none",
            categoryFilter === cat ? "bg-accent/15 text-accent border-accent/30" : "border-border/30 text-muted-foreground hover:text-foreground"
          ),
...
function Header({ onCreateTask }) {
  ...
  const [confirmClearOpen, setConfirmClearOpen] = reactExports.useState(false);
  ...
  function handleMarkAll() {
    markAllCompleted();
    ue.success("All tasks marked complete");
  }
  function handleDeleteCompleted() {
  ...
  if (typeof window !== "undefined") {
    window.__focusSearch = focusSearch;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 bg-card/80 backdrop-blur-lg border-b border-border/30 shadow-glass-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 md:px-6 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-accent/20 flex items-center justify-center ring-1 ring-accent/30 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCheck, { className: "w-4 h-4 text-accent", strokeWidth: 2 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-base text-foreground hidden sm:block tracking-tight", children: "DoFlow" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 ml-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-1.5 bg-muted/40 rounded-full px-2.5 py-0.5 border border-border/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-accent font-semibold tabular-nums", children: activeTodos.length }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: darkMode ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-4 h-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
      ...
      todos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1 bg-muted/50 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-muted-foreground tabular-nums", children: [
          completionPct,
          "%"
        ] })
      ] })
...
const NAV_ITEMS = [
  { icon: Inbox, label: "Inbox", filter: "all" },
  { icon: CalendarDays, label: "Today", filter: "today" },
  { icon: CalendarClock, label: "Upcoming", filter: "upcoming" }
];
function Layout({ children, onCreateTask }) {
  const isMobile = useIsMobile();
  const [mobileNavOpen, setMobileNavOpen] = reactExports.useState(false);
  const [projectsExpanded, setProjectsExpanded] = reactExports.useState(true);
  const [activeNav, setActiveNav] = reactExports.useState("all");
  const { todos, getCategories, setFilter, setCategoryFilter, categoryFilter } = useTodoStore();
  const categories = getCategories();
  const activeTodayCount = todos.filter(
    (t) => !t.completed && t.dueDate && t.dueDate <= Date.now() + 864e5
  ).length;
  const activeCount = todos.filter((t) => !t.completed).length;
  function handleNavItem(nav) {
    setActiveNav(nav);
    setCategoryFilter(null);
    if (nav === "all") {
      setFilter("all");
  ...
  const SidebarContent = /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 pt-5 pb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-accent/20 flex items-center justify-center ring-1 ring-accent/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutList, { className: "w-4 h-4 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-base text-foreground tracking-tight", children: "DoFlow" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "opacity-30 mb-2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "px-2 space-y-0.5", children: NAV_ITEMS.map((item) => {
      const isActive = activeNav === item.filter && !categoryFilter;
      const count2 = item.filter === "all" ? activeCount : item.filter === "today" ? activeTodayCount : 0;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: cn(
            ...
            isActive ? "bg-accent/15 text-accent ring-1 ring-accent/20" : "text-muted-foreground hover:bg-muted/50 hover:text-foreground"
          ),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "w-4 h-4 shrink-0", strokeWidth: 1.8 }),
            ...
            count2 > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                className: cn(
                  ...
                  isActive ? "bg-accent/20 text-accent border-accent/30" : "bg-muted text-muted-foreground"
                ),
                children: count2
              }
            )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "opacity-30 my-3 mx-2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 flex-1 min-h-0 overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
      ...
      projectsExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 space-y-0.5 animate-fade-in-up", children: [
        categories.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-3 py-2 text-xs text-muted-foreground/60 italic", children: "No categories yet" }),
        categories.map((cat) => {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: cn(
                      ...
                      !["Work", "Personal", "Health"].includes(cat) && "bg-chart-5"
                    )
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-left font-medium", children: cat }),
                catCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono tabular-nums text-muted-foreground", children: catCount })
              ]
            },
            cat
          );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 border-t border-border/20 mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground/50 text-center", children: [
      "© ",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { onCreateTask }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 min-h-0 relative", children: [
      !isMobile && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-56 shrink-0 border-r border-border/20 bg-card/40 backdrop-blur-sm flex flex-col sticky top-[57px] h-[calc(100vh-57px)] overflow-hidden", children: SidebarContent }),
      isMobile && mobileNavOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            role: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed left-0 top-0 bottom-0 z-50 w-64 bg-card border-r border-border/30 shadow-glass-xl animate-fade-in-up flex flex-col", children: SidebarContent })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 min-w-0", children: [
        isMobile && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-3 pb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-4 h-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Menu" })
            ]
          }
        ) }),
        children
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: (current == null ? void 0 : current.label) ?? "Sort" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      DropdownMenuContent,
      {
        align: "end",
        className: "w-44 glass-card border-border/30",
        children: SORT_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DropdownMenuItem,
          {
            ...
            children: [
              sortOption === opt.value ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3.5 h-3.5 text-accent shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3.5 h-3.5 shrink-0" }),
              opt.label
            ]
          },
          opt.value
...
const configs = {
  all: {
    Icon: SquareCheckBig,
    title: "No tasks yet",
    description: "You're all clear! Create your first task to get started and stay on top of your day.",
    cta: "Create your first task"
  },
  filtered: {
    Icon: Funnel,
    title: "No matching tasks",
    description: "No tasks match the current filter. Try adjusting your filters or create a new task.",
    cta: "Clear filters"
  },
  search: {
    Icon: Search,
    title: "Nothing found",
    description: "No tasks match your search. Try different keywords or clear the search.",
    cta: "Clear search"
  }
};
function EmptyState({
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full bg-accent/10 flex items-center justify-center ring-1 ring-accent/20 shadow-glass-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-8 h-8 text-accent", strokeWidth: 1.5 }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-3 rounded-full bg-accent/5 blur-xl" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-xl text-foreground mb-2", children: config.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs leading-relaxed mb-6", children: config.description }),
        onCreateTask && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
...
function SubtaskList({ todoId, subtasks }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    subtasks.map((sub, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Checkbox,
        {
          id: `sub-${sub.id}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleAdd, className: "flex gap-2 mt-2 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
...
function TaskCard({
  ...
  const subtaskPct = todo.subtasks.length > 0 ? completedSubs / todo.subtasks.length * 100 : 0;
  const cfg = PRIORITY_CONFIG[todo.priority];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref: cardRef,
      "data-ocid": `task.item.${index2}`,
      draggable: true,
      onDragStart: (e) => onDragStart == null ? void 0 : onDragStart(e, todo.id),
      onDragOver: (e) => {
        e.preventDefault();
        setIsDragOver(true);
        onDragOver == null ? void 0 : onDragOver(e);
      },
      onDragLeave: () => setIsDragOver(false),
      onDrop: (e) => {
        setIsDragOver(false);
        onDrop == null ? void 0 : onDrop(e, todo.id);
      },
      className: cn(
      ...
      style: {
        animationDelay: `${Math.min(index2 * 50, 400)}ms`,
        animationFillMode: "both"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "w-3.5 h-3.5 text-muted-foreground/30 group-hover:text-muted-foreground/60 mt-1 shrink-0 cursor-grab active:cursor-grabbing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              "data-ocid": `task.checkbox.${index2}`,
              onClick: () => {
                toggleTodo(todo.id);
                if (!todo.completed) ue.success("Task completed! 🎉");
              },
              ...
              children: todo.completed ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: "w-5 h-5 text-muted-foreground/50 group-hover:text-muted-foreground transition-colors" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: highlightText(todo.title, searchQuery)
              }
            ),
            todo.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 line-clamp-1", children: highlightText(todo.description, searchQuery) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { className: "w-2.5 h-2.5" }),
                    cfg.label
                  ]
                }
              ),
              todo.category && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Badge,
                {
                  variant: "outline",
              ...
              todo.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: cn(
                    "inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs",
                    isOverdue(todo.dueDate) && !todo.completed ? "bg-destructive/15 text-destructive border border-destructive/20" : "bg-muted/40 text-muted-foreground border border-border/20"
                  ),
                  children: [
              ...
              todo.subtasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-mono tabular-nums ml-auto", children: [
                completedSubs,
                "/",
                todo.subtasks.length
              ] })
            ] }),
            todo.subtasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 h-0.5 bg-muted/40 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-smooth shrink-0", children: [
            todo.subtasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                "data-ocid": `task.expand.${index2}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                type: "button",
                "data-ocid": `task.edit_button.${index2}`,
                className: "p-1.5 rounded-md hover:bg-muted/60 text-muted-foreground hover:text-foreground transition-colors",
                onClick: () => onEdit(todo),
        ...
        expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 ml-11 border-t border-border/20 pt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SubtaskList, { todoId: todo.id, subtasks: todo.subtasks }) })
      ]
    }
  );
}
...
function TaskList({ onEdit }) {
  ...
  const handleDragStart = reactExports.useCallback((e, id) => {
  ...
  const emptyType = searchQuery ? "search" : filter !== "all" || categoryFilter ? "filtered" : "all";
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "task_list.loading_state", children: Array.from({ length: 3 }).map((_, i) => (
      // biome-ignore lint/suspicious/noArrayIndexKey: skeleton placeholders
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 w-full rounded-xl" }, i)
    )) });
  }
  if (filteredTodos.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { type: emptyType, onCreateTask: handleEmptyStateCta });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "task_list.list", className: "space-y-2", children: filteredTodos.map((todo, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    TaskCard,
    {
      todo,
      index: idx + 1,
...
function TaskModal({ open, onClose, editTodo }) {
  ...
  const prevId = reactExports.useRef(void 0);
  reactExports.useEffect(() => {
    if (!open) return;
    if ((editTodo == null ? void 0 : editTodo.id) !== prevId.current) {
      prevId.current = editTodo == null ? void 0 : editTodo.id;
      setTitle((editTodo == null ? void 0 : editTodo.title) ?? "");
      setDescription((editTodo == null ? void 0 : editTodo.description) ?? "");
      setPriority((editTodo == null ? void 0 : editTodo.priority) ?? "medium");
      setDueDate(
        (editTodo == null ? void 0 : editTodo.dueDate) ? new Date(editTodo.dueDate).toISOString().slice(0, 10) : ""
      );
      setCategory((editTodo == null ? void 0 : editTodo.category) ?? "");
      setNewCategory("");
    }
  }, [open, editTodo]);
  reactExports.useEffect(() => {
    if (!open) {
      prevId.current = void 0;
      setTitle("");
      setDescription("");
      setPriority("medium");
      setDueDate("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display font-semibold text-base", children: editTodo ? "Edit Task" : "New Task" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4 mt-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "glass-card border-border/30", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-muted-foreground", children: "Category" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "opacity-20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: editTodo ? "Save changes" : "Create task"
              }
            )
          ] })
        ] })
  ...
  reactExports.useEffect(() => {
    function handleKeyDown(e) {
      ...
      if ((e.ctrlKey || e.metaKey) && e.key === "n") {
        e.preventDefault();
        onNewTask == null ? void 0 : onNewTask();
      }
      if ((e.ctrlKey || e.metaKey) && e.key === "k") {
        e.preventDefault();
        onFocusSearch == null ? void 0 : onFocusSearch();
      }
...
function TodoPage() {
  ...
  const [editTodo, setEditTodo] = reactExports.useState(null);
  ...
  const openEdit = reactExports.useCallback((todo) => {
    setEditTodo(todo);
    setModalOpen(true);
  }, []);
  ...
  useKeyboardShortcuts({
    ...
    onFocusSearch: () => {
      var _a;
      if (typeof window !== "undefined") {
        (_a = window.__focusSearch) == null ? void 0 : _a.call(window);
      }
    }
  });
  const pageTitle = categoryFilter ? categoryFilter : filter === "active" ? "Active Tasks" : filter === "completed" ? "Completed" : "All Tasks";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { onCreateTask: openCreate, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 md:px-6 py-5 max-w-3xl mx-auto w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-foreground tracking-tight", children: pageTitle }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SortControls, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(BulkActionsMenu, {})
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterPanel, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TaskList, { onEdit: openEdit })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TaskModal, { open: modalOpen, onClose: closeModal, editTodo })
  ] });
}
export {
  TodoPage
