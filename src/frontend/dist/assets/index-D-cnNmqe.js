...
const seedTodos = initialTodos.length > 0 ? initialTodos : [
  {
    id: generateId(),
    title: "Design system tokens review",
    description: "Audit OKLCH palette, verify contrast ratios across all theme variants",
    priority: "high",
    dueDate: Date.now() + 2 * 864e5,
    category: "Work",
    completed: false,
  ...
  },
  {
    ...
    description: "Implement touch-friendly DnD for both desktop and mobile",
    priority: "medium",
    dueDate: Date.now() + 5 * 864e5,
    category: "Work",
    completed: false,
  ...
  },
  {
    ...
    description: "Gather sprint metrics and write talking points for the retro",
    priority: "high",
    dueDate: Date.now() + 864e5,
    category: "Work",
    completed: false,
  ...
  },
  {
    ...
    description: "Pick up ingredients for meal prep: chicken, quinoa, veggies",
    priority: "low",
    dueDate: Date.now() + 2 * 864e5,
    category: "Personal",
    completed: false,
...
const useTodoStore = create()(
  subscribeWithSelector((set, get) => ({
    ...
    darkMode: (initialPrefs == null ? void 0 : initialPrefs.darkMode) ?? true,
    sidebarOpen: false,
    ...
    updateTodo: (id, changes) => {
      const updated = get().todos.map(
        (t) => t.id === id ? { ...t, ...changes } : t
      );
      set({ todos: updated });
      saveTodos(updated);
    },
    ...
    addSubtask: (todoId, title) => {
      ...
      const updated = get().todos.map(
        (t) => t.id === todoId ? { ...t, subtasks: [...t.subtasks, subtask] } : t
      );
      set({ todos: updated });
      saveTodos(updated);
    },
    ...
    deleteSubtask: (todoId, subtaskId) => {
      const updated = get().todos.map(
        (t) => t.id === todoId ? { ...t, subtasks: t.subtasks.filter((s) => s.id !== subtaskId) } : t
      );
      set({ todos: updated });
      saveTodos(updated);
    },
    ...
    getFilteredTodos: () => {
      ...
      if (searchQuery.trim()) {
        ...
        result = result.filter(
          (t) => {
            var _a2;
            return t.title.toLowerCase().includes(q) || t.description.toLowerCase().includes(q) || (((_a2 = t.category) == null ? void 0 : _a2.toLowerCase().includes(q)) ?? false);
          }
        );
      }
      result.sort((a, b) => {
...
const TodoPage = reactExports.lazy(
  () => __vitePreload(() => import("./TodoPage-DZnhxIPQ.js"), true ? [] : void 0).then((m) => ({ default: m.TodoPage }))
);
const queryClient$1 = new QueryClient({
  defaultOptions: { queries: { staleTime: 1e3 * 60 * 5 } }
});
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ThemeProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TodoPage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      $e,
      {
        position: "bottom-right",
        toastOptions: {
          className: "glass-card !bg-card !border-border/30 !text-foreground !shadow-glass-lg",
          duration: 4e3
        }
      }
    )
